...
<div class="row">
  <div class="col-lg-8 col-sm-6">
    ...
    <hr>
    <h3>L'entreprise</h3>
    <p> Notre entreprise familiale met tout son savoir-faire à votre disposition dans les domaines du jardin et du paysagisme.</p>
  ...
  <img src="<?php echo base_url("assets/img/landscape_logo.jpg ?>")?>"  class="w-100 LoGo" alt="Pelle" >
